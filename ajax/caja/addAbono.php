...
if(isset($_POST)){
		...
		$saldo_caja = ($saldo_caja + $abono_caja);

		$query = "INSERT INTO caja (id_residente, fecha_caja, descrip_caja, abono_caja, tipo_caja, saldo_caja) VALUES ('$id_residente', '$fecha_caja', '$descrip_caja', '$abono_caja', '$tipo_caja', '$saldo_caja')";
